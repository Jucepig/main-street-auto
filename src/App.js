...
class App extends Component {
  ...
  getVehicles() {
    ...
    .then(res => {
      toast.success('Got your cars!')
      this.setState({
        vehiclesToDisplay : res.data
      })
    })
    .catch(() => toast.error("Uh-oh! Didn't get any cars!"))
  }
  ...
  sellCar(id) {
    ...
    .then(res => {
      ...
      toast.success('Car has been sold!')
    })
    .catch(()=> {
      toast.error("Uh-oh! Failed to sell car!")
    })
  }
  ...
  updatePrice(priceChange, id) {
    ...
    .then(res => {
      ...
      toast.success('The vehicle price has been updated!')
    })
    .catch(() => {
      toast.error('Uh-Oh! Failed to update the price!')
    })
  }
  ...
  addCar() {
    ...
    .then(res => {
      ...
      toast.success('The new car has been added!')
    })
    .catch(()=> {
      toast.error('Sorry sir, this car cannot be sold!')
    })
  }
